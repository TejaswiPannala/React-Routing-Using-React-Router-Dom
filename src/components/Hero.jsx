    ...
    <div class="font-sans max-w-6xl max-md:max-w-md mx-auto">
      <div class="grid md:grid-cols-2 items-center md:gap-8 gap-6">
        <div class="max-md:order-1 max-md:text-center z-50 relative">
          <h2 class="text-gray-800 lg:text-6xl md:text-5xl text-3xl font-extrabold mb-4 md:!leading-[56px]">
            <span class="text-blue-600">Smart</span> Business with{" "}
            <span class="text-blue-600">Smart</span> People
          </h2>
          ...
          <button
            type="button"
            class="mt-6 bg-blue-600 hover:bg-transparent hover:text-blue-600 border-2 border-blue-600 transition-all text-white font-semibold text-sm tracking-wide rounded-md px-6 py-2.5"
          >
            Get Started
          </button>
        ...
        <div class="lg:h-[550px] md:h-[550px] flex items-center relative max-md:before:hidden before:absolute before:bg-[#DEE2E5] before:h-[120%] before:w-[120%] before:right-0 before:z-0">
          <img
            ...
            class="rounded-md lg:w-4/5 z-50 relative"
      ...
      <div class="grid md:grid-cols-3 gap-4 z-50 relative md:px-4 max-md:mt-12 mb-12">
        <div class="bg-white p-6 shadow rounded-md">
          <svg
            ...
            fill="currentColor"
            class="w-11 h-11 mb-4 inline-block bg-blue-100 p-3 rounded-md"
            viewBox="0 0 32 32"
          >
            <path
          ...
          <a
            ...
            class="text-blue-600 font-bold inline-block text-sm hover:underline mt-4"
          >
            Learn more
          </a>
        </div>
